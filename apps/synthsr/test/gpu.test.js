...
import model from '../src/gpu-model.json' with { type: 'json' };
import { planGpuGraph, createGpuSession } from '../src/gpu-session.js';
import { conv3dDispatch, packConvWeights } from '../src/gpu-conv3d.js';
